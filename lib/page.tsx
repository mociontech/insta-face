...
import { checkUserByCode, getAllCodes } from "@/lib/firebase";
import { offlineStorage, sendScore } from "@/lib/offline";
  ...
  async function nextPage() {
    ...
    if (typeof window !== "undefined" && !navigator.onLine) {
      ...
      try {
        ...
        // Por ahora, solo limpiamos el input y mostramos un mensaje temporal.
        setInputValue("");
        setLoading(false);
        // Opcional: router.push('/siguiente-paso-offline');
        return;
      } catch (e) {
