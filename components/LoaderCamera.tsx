export default function Loader() {
  return (
    <div className="loader absolute z-50 h-screen w-screen flex justify-center items-center bg-black/10">
          <svg
      xmlns="http://www.w3.org/2000/svg"
      height="80"
      viewBox="0 -960 960 960"
      width="800"
      className="animate-spin w-[200px] h-[200px] mb-[200px]"
    >
      <path
        fill="#F98768"
      ...
      {/* <img src={"/logoclaro.png"} alt="clarologo"  >
